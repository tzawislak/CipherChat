...
public:
    ...
    void setupUi(QDialog *NewContactDialog)
    {
        ...
        NewContactDialog->resize(510, 214);
        formLayoutWidget = new QWidget(NewContactDialog);
        formLayoutWidget->setObjectName(QStringLiteral("formLayoutWidget"));
        formLayoutWidget->setGeometry(QRect(9, 9, 491, 148));
        ...
        layoutWidget = new QWidget(NewContactDialog);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(320, 170, 168, 24));
    ...
    void retranslateUi(QDialog *NewContactDialog)
    {
        ...
        label_ip->setText(QApplication::translate("NewContactDialog", "ID", 0));
